...
with st.spinner('Laoding Pokemon Data...'):
...
fig2=px.bar(ss,x='Name',y='Sp. Atk')
tabs[1].subheader(f'{type1} Stats')
...
fig1=px.histogram(ss,x='Sp. Def', nbins=20)
fig2=px.bar(ss,x='Name',y='Sp. Def')
tabs[1].subheader(f'{type1} Stats')
...
fig1=px.histogram(ss, x='Speed', nbins=20)
fig2=px.bar(ss, x='Name',y='Speed')
tabs[1].subheader(f'{type1} Stats')
