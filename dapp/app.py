...
#2. create a new forder called dapp
#3. create a new file called app.py
#4. copy the canada.xlsx file to dapp folder
#5. strealit run dapp/app.py
...
c2.metric('Avg. Immigrants/yr',f'{round(avg_immigrants)} people','👨‍👩‍👧‍👦/years')
